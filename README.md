...
Дважды в сутки — в 00:00 и 09:00 MSK — GitHub Actions запускает crawl4ai, парсит index-страницы, тянет статьи, собирает RSS 2.0 и коммитит в `feeds/`. Ночной прогон готовит свежие фиды к смежному n8n workflow (08:00 MSK), дневной подхватывает то, что вышло за день.
